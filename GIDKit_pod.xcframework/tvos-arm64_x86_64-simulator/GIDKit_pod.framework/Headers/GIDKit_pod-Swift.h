...
#ifndef GIDKIT_POD_SWIFT_H
#define GIDKIT_POD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GIDKit_pod",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC10GIDKit_pod20GIDCaptchaController")
@interface GIDCaptchaController : UIViewController
...
SWIFT_CLASS("_TtC10GIDKit_pod14KeyboardButton")
@interface KeyboardButton : UIButton
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull selectedTitleColor;
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull pressedTitleColor;
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull pressedBackgroundColor;
@property (nonatomic, strong) IBInspectable UIColor * _Nullable pressedBackgroundEndColor;
...
@property (nonatomic) IBInspectable CGFloat focusedBorderWidth;
@property (nonatomic) IBInspectable CGFloat normalBorderWidth;
@property (nonatomic, strong) IBInspectable UIColor * _Nullable focusedBorderColor;
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull focusedSpaceTitleColor;
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull normalSpaceTitleColor;
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull focusedSpaceBackgroundColor;
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull normalSpaceBackgroundColor;
@property (nonatomic, strong) IBInspectable UIFont * _Nonnull titleFont;
@property (nonatomic, copy) IBInspectable NSString * _Nullable extraTitle;
