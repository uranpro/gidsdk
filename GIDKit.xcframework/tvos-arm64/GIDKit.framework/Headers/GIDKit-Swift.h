...
#ifndef GIDKIT_SWIFT_H
#define GIDKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GIDKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC6GIDKit20GIDCaptchaController")
...
SWIFT_CLASS("_TtC6GIDKit14KeyboardButton")
