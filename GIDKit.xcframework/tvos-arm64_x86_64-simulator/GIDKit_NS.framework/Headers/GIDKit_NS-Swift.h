...
#ifndef GIDKIT_NS_SWIFT_H
#define GIDKIT_NS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GIDKit_NS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC9GIDKit_NS20GIDCaptchaController")
...
SWIFT_CLASS("_TtC9GIDKit_NS14KeyboardButton")
