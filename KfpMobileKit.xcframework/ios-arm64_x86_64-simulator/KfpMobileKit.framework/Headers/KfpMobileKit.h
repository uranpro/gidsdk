...
- (void)activateRootUrl:(NSString * _Nullable)rootUrl result:(void (^ _Nullable)(KMKKfpActivateResult *))result __attribute__((swift_name("activate(rootUrl:result:)")));
...
+ (void)printlnWithTimeMessage:(id _Nullable)message __attribute__((swift_name("printlnWithTime(message:)")));
